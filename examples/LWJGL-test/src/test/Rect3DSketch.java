...
public class Rect3DSketch extends Sketch {
    ...
    public void setup() throws IOException {
        ...
        vertices = MemoryUtil.memAlloc(byteSizeOf(XYZC, 4));
    ...
    public void draw() {
        ...
        bgfx_dbg_text_printf(0, 0, 0x0f, "Rect3D");
    }
    ...
    public static void main(String[] args) {
        App.main("test.Rect3DSketch", width, height);
    }
}